module.exports = Object.freeze({
    ...
    REMOTE_DROP_HARVESTER_CONFIG: [MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,WORK,WORK,WORK,WORK,WORK,WORK,WORK,WORK,CARRY,CARRY,CARRY,CARRY,CARRY,CARRY,CARRY,CARRY],
    REMOTE_DROP_HARVESTER_COST: 1600,
    ...
    TRANSPORTER_CONFIG: [CARRY,CARRY,CARRY,CARRY,CARRY,CARRY,CARRY,CARRY,MOVE,MOVE,MOVE,MOVE],
    TRANSPORTER_COST: 600,
    ...
    BUILDER_CONFIG: [WORK,WORK,WORK,WORK,WORK,WORK,WORK,WORK,WORK,WORK,CARRY,CARRY,CARRY,CARRY,CARRY,CARRY,CARRY,CARRY,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE],
    BUILDER_COST: 1850, //1050
    BUILDER_COUNT: 1, //2
