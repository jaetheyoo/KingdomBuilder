var warRanger = {
    // Game.spawns['Spawn1'].spawnCreep(['tough','tough','tough','tough','tough','move','move','move','ranged_attack','ranged_attack','ranged_attack','ranged_attack','ranged_attack','ranged_attack','ranged_attack'] , 'Ranger',{memory:{role: 'warRanger', getBoosted:['XGHO2','XZHO2','XKHO2'], attackFlag:'attack'}});
    /** @param {Creep} creep **/
